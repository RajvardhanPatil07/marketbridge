        ...
        request = RiskCheckRequest.model_validate(
            {
                ...
                "account": {
                    ...
                    "current_leverage": float((existing / equity).quantize(Decimal("0.01"))) if existing else 0,
    ...
    request = RiskCheckRequest.model_validate(
        {
            ...
            "account": {
                ...
                "current_leverage": float((existing_position_usd / account_equity_usd).quantize(Decimal("0.01"))) if existing_position_usd else 0,
